...
/** Smooth-scroll helper for button onClick handlers */
function scrollTo(id: string) {
  const el = document.getElementById(id);
  if (el) el.scrollIntoView({ behavior: "smooth", block: "start" });
}

/** Hook: observe a container ref and add 'revealed' class to .scroll-reveal children when in viewport */
  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-screen flex flex-col justify-center overflow-hidden scroll-reveal reveal-up" style={{ animationDuration: '1.1s' }}>
        ...
        <div className="container relative z-10 pt-24 pb-16 md:pt-0 md:pb-0">
      ...
      {/* Services Section */}
      <section id="services" className="py-14 md:py-20 border-t border-border scroll-reveal reveal-up" style={{ animationDuration: '1s' }}>
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 gap-6 md:gap-8 mb-12 scroll-reveal reveal-up stagger-children" style={{ animationDuration: '0.9s' }}>
            {/* Voice Agents */}
            <div 
      ...
      <section id="platform" className="py-14 md:py-20 border-t border-border scroll-reveal reveal-up" style={{ animationDuration: '1s' }}>
        <div className="container">
      ...
      {/* Features Section */}
      <section className="py-14 md:py-20 border-t border-border scroll-reveal reveal-up" style={{ animationDuration: '1s' }}>
        <div className="container">
          <div className="text-center mb-16">
            <h2 
              className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4"
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 scroll-reveal reveal-up stagger-children" style={{ animationDuration: '0.9s' }}>
            {[
              {
                icon: Headphones,
      ...
      {/* Pricing CTA Section */}
      <section className="py-14 md:py-20 border-t border-border bg-card/30 scroll-reveal reveal-scale" style={{ animationDuration: '1s' }}>
        <div className="container">
      ...
      <section className="py-14 md:py-20 border-t border-border bg-card/30 scroll-reveal reveal-up" style={{ animationDuration: '1s' }}>
        <div className="container">
          <div className="text-center mb-16">
            <h2 
              className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4"
      ...
      {/* CTA Section */}
      <section id="contact" className="py-14 md:py-20 border-t border-border scroll-reveal reveal-scale" style={{ animationDuration: '1s' }}>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href="#services" className="hover:text-cyan-400 transition">Voice Agents</a></li>
                <li><a href="#services" className="hover:text-cyan-400 transition">Text Agents</a></li>
                <li><a href="#services" className="hover:text-cyan-400 transition">Website Agents</a></li>
              </ul>
            </div>
            <div>
